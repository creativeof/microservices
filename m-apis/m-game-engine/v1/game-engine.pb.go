...
// 	protoc        v3.6.0
// source: m-game-engine/v1/game-engine.proto
...
func (x *GetSizeRequest) Reset() {
	*x = GetSizeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_m_game_engine_v1_game_engine_proto_msgTypes[0]
...
func (*GetSizeRequest) Descriptor() ([]byte, []int) {
	return file_m_game_engine_v1_game_engine_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetSizeResponse) Reset() {
	*x = GetSizeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_m_game_engine_v1_game_engine_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetSizeResponse) Descriptor() ([]byte, []int) {
	return file_m_game_engine_v1_game_engine_proto_rawDescGZIP(), []int{1}
}
...
func (x *SetScoreRequest) Reset() {
	*x = SetScoreRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_m_game_engine_v1_game_engine_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetScoreRequest) Descriptor() ([]byte, []int) {
	return file_m_game_engine_v1_game_engine_proto_rawDescGZIP(), []int{2}
}
...
func (x *SetScoreResponse) Reset() {
	*x = SetScoreResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_m_game_engine_v1_game_engine_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetScoreResponse) Descriptor() ([]byte, []int) {
	return file_m_game_engine_v1_game_engine_proto_rawDescGZIP(), []int{3}
}
...
var File_m_game_engine_v1_game_engine_proto protoreflect.FileDescriptor

var file_m_game_engine_v1_game_engine_proto_rawDesc = []byte{
	0x0a, 0x22, 0x6d, 0x2d, 0x67, 0x61, 0x6d, 0x65, 0x2d, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2f,
	0x76, 0x31, 0x2f, 0x67, 0x61, 0x6d, 0x65, 0x2d, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x6d, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x65, 0x6e, 0x67, 0x69,
	...
	,
}

var (
	file_m_game_engine_v1_game_engine_proto_rawDescOnce sync.Once
	file_m_game_engine_v1_game_engine_proto_rawDescData = file_m_game_engine_v1_game_engine_proto_rawDesc
)

func file_m_game_engine_v1_game_engine_proto_rawDescGZIP() []byte {
	file_m_game_engine_v1_game_engine_proto_rawDescOnce.Do(func() {
		file_m_game_engine_v1_game_engine_proto_rawDescData = protoimpl.X.CompressGZIP(file_m_game_engine_v1_game_engine_proto_rawDescData)
	})
	return file_m_game_engine_v1_game_engine_proto_rawDescData
}

var file_m_game_engine_v1_game_engine_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_m_game_engine_v1_game_engine_proto_goTypes = []interface{}{
...
var file_m_game_engine_v1_game_engine_proto_depIdxs = []int32{
...
func init() { file_m_game_engine_v1_game_engine_proto_init() }
func file_m_game_engine_v1_game_engine_proto_init() {
	if File_m_game_engine_v1_game_engine_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_m_game_engine_v1_game_engine_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_m_game_engine_v1_game_engine_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_m_game_engine_v1_game_engine_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_m_game_engine_v1_game_engine_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_m_game_engine_v1_game_engine_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_m_game_engine_v1_game_engine_proto_goTypes,
		DependencyIndexes: file_m_game_engine_v1_game_engine_proto_depIdxs,
		MessageInfos:      file_m_game_engine_v1_game_engine_proto_msgTypes,
	}.Build()
	File_m_game_engine_v1_game_engine_proto = out.File
	file_m_game_engine_v1_game_engine_proto_rawDesc = nil
	file_m_game_engine_v1_game_engine_proto_goTypes = nil
	file_m_game_engine_v1_game_engine_proto_depIdxs = nil
}
...
var _GameEngine_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "m-game-engine/v1/game-engine.proto",
}
